...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\small\textbf{Technologies}: JavaScript, HTML, CSS, Sass (SCSS), React, React Bootstrap, React Router, Reselect, Jest, React Testing Library, Create React App, PropTypes, Node.js, Express, ESLint, Prettier, Husky, Yarn, date-fns, Visual Studio Code, SVN with git-svn}
      ...
      \resumeItemListStart
        ...
        \resumeItem
          {Implemented data tables with pagination, sorting, expandable rows with sub-component rendering and sub-tables.}
        \resumeItem
    ...
    \resumeSubheading
      ...
      {\small\textbf{Technologies}: JavaScript, Java, HTML, CSS, Sass (SCSS), Ember.js, Handlebars.js, Git, Gulp, JSHint, Karma, Mocha, Chai, npm, jQuery, Selenium, Jenkins, Ant, Maven, FreeMarker, ColdFusion, PostgreSQL, IntelliJ IDEA}
    ...
    \resumeSubheading
      ...
      {\small\textbf{Technologies}: JavaScript, PHP, WordPress, HTML, CSS with Sass (SCSS), Compass, and Susy, jQuery, SVN with git-svn, Jenkins, Ant, npm, Grunt, JSHint, Capistrano}
    ...
    \resumeSubheading
      ...
      {\small\textbf{Technologies}: Java, Java EE, Servlets, JavaScript, LotusScript, Formula Language, Lotus Notes, Lotus Domino, Tomcat, HTML, CSS, XML, XPath, XSLT, SVN, CVS, RCS, Maven, Ant, Make, Jenkins}
